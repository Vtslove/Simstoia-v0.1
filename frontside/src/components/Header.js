...
import CompIcon from "../images/company .jpg"
     ...
     <div className="header">
        ...
        <div className="header-searchusers">
         ...
         <div className="header-left ">
             <Link to ={`/company/${auth.user._id}`}>

             </Link>

         <Link to ={`/profile/${auth.user._id}`}> <div className="header-leftAvatar">
                 <Avatar src={auth.user.avatar}/>
                 <h4 className="header-name">{auth.user.fullname}</h4>
             </div>
             </Link>

             <Link to="/companyCreate">
             <IconButton className="company-button">
                 <img className="company-icon" src={CompIcon} />
             </IconButton>
             </Link>
             <Link to="/message">
             <IconButton  >
